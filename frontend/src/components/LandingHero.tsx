  ...
  return (
    <section className="relative flex min-h-[84vh] w-full flex-col items-center justify-center overflow-hidden py-16">
      ...
      >
        ...
        <motion.div className="relative mb-4" variants={itemVariants}>
          <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
            <h1
              ...
              style={{
                backgroundImage: "linear-gradient(120deg, rgba(255,255,255,0.08), rgba(77,141,255,0.28), rgba(99,230,255,0.12))",
                color: "transparent",
        ...
        {/* Subtitle */}
        <motion.p 
          className="mb-6 mt-2 text-xs uppercase tracking-[0.4em] text-white/28 sm:text-sm"
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          <p className="mb-3 text-xl font-light text-white/85 sm:text-2xl md:text-3xl">
            桥梁病害智能判读系统
          </p>
        ...
        <motion.div
          className="mt-8 grid w-full max-w-4xl grid-cols-1 gap-3 text-left sm:grid-cols-3"
          variants={itemVariants}
        >
          {[
