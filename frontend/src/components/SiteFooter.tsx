...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/5 py-12 mt-20 relative z-10 w-full">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-3">
          <div className="h-8 w-8 rounded-lg bg-black border border-white/10 flex items-center justify-center">
